...
urlpatterns = [
    ...
    path('topic/verify/<int:pk>/confirm/', views.TopicConfirmView.as_view(), name='topic-confirm'),
    path('topic/verify/<int:pk>/decline', views.TopicDeleteView.as_view(), name='topic-decline'),
